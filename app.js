'use strict';
const Q = window.Quest, E = Q.escape, projects = window.DEMO.projects;
let filter = 'all';
...
function render() {
  ...
  const openProjects = projects.filter(p => p.status !== '已完成');
  ...
  document.querySelector('#projects').innerHTML = window.DEMO.lists.map(list => {
